 ...
 * @author DAvil
 */
@WebServlet(name = "MensualesRep", urlPatterns = {"/MensualesRep"})
...
//        processRequest(request, response);
    ...
    ArrayList <MensualesRepar> listaMenRep = MensualRep.listaMenRep(rut, fecDesde, fecHasta);
